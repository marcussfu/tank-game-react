...
describe('LivesDisplay', () => {
    it('renders the current lives count prefixed with × in a solo game', () => {
        renderWithStore(<LivesDisplay />, {
            hud: { timeRemainingSec: 100, enemiesRemaining: 0, levelIndex: 0, totalLevels: 1, lives: 2, livesP2: null },
        });
    ...
    it('renders ×0 once lives are exhausted', () => {
        renderWithStore(<LivesDisplay />, {
            hud: { timeRemainingSec: 100, enemiesRemaining: 0, levelIndex: 0, totalLevels: 1, lives: 0, livesP2: null },
        });
    ...
    it('renders a labelled P1/P2 pair in local co-op', () => {
        renderWithStore(<LivesDisplay />, {
            hud: { timeRemainingSec: 100, enemiesRemaining: 0, levelIndex: 0, totalLevels: 1, lives: 3, livesP2: 1 },
        });
